...
3. Edit the `backend/config.js` file in your GitHub repository to link everything together:
...
4. Commit your changes to `backend/config.js`. This commit will automatically trigger a GitHub Action to deploy the updated backend code securely!
